...
var DOMElements = exports.DOMElements = new Map([["form", document.querySelector('.form')], ["containerWorkouts", document.querySelector('.workouts')], ["inputType", document.querySelector('.form__input--type')], ["inputDistance", document.querySelector('.form__input--distance')], ["inputDuration", document.querySelector('.form__input--duration')], ["inputCadence", document.querySelector('.form__input--cadence')], ["inputElevation", document.querySelector('.form__input--elevation')], ["formRowHidden", "form__row--hidden"], ["crossClass", ".cross"], ["workoutClass", ".workout"]]);

var workoutHtmlString = exports.workoutHtmlString = function workoutHtmlString(workout) {
...
var View = function () {
    ...
    _createClass(View, [{
        ...
        value: function loadMap(coords) {
            var map = L.map('map').setView([coords.latitude, coords.longitude], this._zoom);
        ...
        key: "setMarker",
        value: function setMarker(coords, date, id) {
            var marker = L.marker([coords.lat, coords.lng]).addTo(this.map).bindPopup(date).openPopup();
        ...
        value: function showForm() {
            _utils.DOMElements.get("form").classList.remove("hidden");
        }
        ...
        value: function removeForm() {
            _utils.DOMElements.get("form").style.display = 'none';
            _utils.DOMElements.get("form").classList.add("hidden");
            setTimeout(function () {
                _utils.DOMElements.get("form").style.display = "grid";
            });
        }
        ...
        key: "switchElevGainAndCadence",
        value: function switchElevGainAndCadence() {
            this.formState = this.formState == "elevGain" ? "cadence" : "elevGain";
            _utils.DOMElements.get("inputCadence").parentNode.classList.toggle(_utils.DOMElements.get("formRowHidden"));
            _utils.DOMElements.get("inputElevation").parentNode.classList.toggle(_utils.DOMElements.get("formRowHidden"));
        }
    }, {
        key: "clearForm",
        value: function clearForm() {
            // clears the field for distance and duration
            ["inputDistance", "inputDuration", "inputElevation", "inputCadence"].forEach(function (el) {
                _utils.DOMElements.get(el).value = "";
            });
            // if the input is set to elevGain -> set it to running
            if (this.formState === "elevGain") {
                _utils.DOMElements.get("inputType").value = "running";
        ...
        value: function getFormInput() {
            var inputValues = {};
            inputValues["distance"] = parseFloat(_utils.DOMElements.get("inputDistance").value);

            inputValues["duration"] = parseFloat(_utils.DOMElements.get("inputDuration").value);

            inputValues["type"] = _utils.DOMElements.get("inputType").value;

            if (inputValues.type == "running") {
                inputValues["cadence"] = parseFloat(_utils.DOMElements.get("inputCadence").value);
            } else {
                inputValues["elevGain"] = parseFloat(_utils.DOMElements.get("inputElevation").value);
            }
            ...
            try {
                for (var _iterator = Object.values(inputValues)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        key: "renderWorkout",
        value: function renderWorkout(workout) {
            // insert the html
            _utils.DOMElements.get("form").insertAdjacentHTML("afterend", (0, _utils.workoutHtmlString)(workout));
        }
        ...
        key: "changeMapFocus",
        value: function changeMapFocus(coords) {
        ...
        key: "deleteWorkout",
        value: function deleteWorkout(dataId) {
            var selection = document.querySelector("[data-id=\"" + dataId + "\"]");
            selection.remove();
        }
    }, {
        key: "zoom",
...
},{"./utils.js":"src/js/utils.js"}],"src/js/MainModel.js":[function(require,module,exports) {
"use strict";
...
var Workout = function () {
    function Workout(id, duration, distance, type, coords) {
    ...
    _createClass(Workout, [{
        ...
        value: function setDescription() {
            var month = _utils.months[this.date.getMonth()];
...
var Cycling = function (_Workout) {
    _inherits(Cycling, _Workout);

    function Cycling(id, duration, distance, coords, elevationGain) {
        _classCallCheck(this, Cycling);

        var _this = _possibleConstructorReturn(this, (Cycling.__proto__ || Object.getPrototypeOf(Cycling)).call(this, id, duration, distance, "cycling", coords));

        _this.elevationGain = elevationGain;
        _this.calculateSpeed();
        return _this;
    }
...
var Running = function (_Workout2) {
    _inherits(Running, _Workout2);

    function Running(id, duration, distance, coords, cadence) {
        _classCallCheck(this, Running);

        var _this2 = _possibleConstructorReturn(this, (Running.__proto__ || Object.getPrototypeOf(Running)).call(this, id, duration, distance, "running", coords));

        _this2.cadence = cadence;
    ...
    _createClass(Model, [{
        ...
        value: function loadDataFromLocalStorage() {
            ...
            if (workouts) {
                ...
                (_workouts = this.workouts).push.apply(_workouts, _toConsumableArray(workouts));
            }
        ...
        key: "addWorkout",
        value: function addWorkout(data) {
            var workout = void 0;
        ...
        key: "getCoordinatesOfWorkout",
        value: function getCoordinatesOfWorkout(id) {
            var workout = this.findWorkout(id);
            if (!workout) {
                return null;
            }
        ...
        key: "findWorkout",
        value: function findWorkout(id) {
            return this.workouts.find(function (el) {
                return el.id === parseInt(id);
            });
        }
    }, {
        key: "deleteWorkout",
        value: function deleteWorkout(id) {
            var index = this.workouts.findIndex(function (el) {
                return el.id === parseInt(id);
            });
            console.log(index);
            if (index != -1) {
...
},{"./utils.js":"src/js/utils.js"}],"src/js/controller.js":[function(require,module,exports) {
'use strict';
// prettier-ignore
...
var _MainModel = require('./MainModel.js');

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

var lastClickedCoordinates = {};

// initializes the map listener that is triggered when the map is clicked
var initMapListeners = function initMapListeners(map) {
    map.on('click', function (event) {
        // saves the coordinates of the click
        lastClickedCoordinates = event.latlng;
        // shows the form
        _MainView.view.showForm();
    });
};

var initSubmitFormListener = function initSubmitFormListener() {
    _utils.DOMElements.get("form").addEventListener("submit", function (e) {
        e.preventDefault();

        // gets the form input
        var input = _MainView.view.getFormInput();
        // if it is undefined
        if (!input) return;

        // remove and clear the form
        _MainView.view.removeForm();
        _MainView.view.clearForm();

        // set the coordinates
        input.coords = lastClickedCoordinates;

        // create a new workout
        var workout = _MainModel.model.addWorkout(input);

        // render the workout
        _MainView.view.renderWorkout(workout);

        // set the marker for the workout
        _MainView.view.setMarker({ lat: lastClickedCoordinates.lat, lng: lastClickedCoordinates.lng }, workout.description, workout.id);
    });
};

// creates an event listener for a click event on the workouts
var initWorkoutListener = function initWorkoutListener() {
    _utils.DOMElements.get("containerWorkouts").addEventListener("click", function (e) {

        // check if the cross was clicked to delete the item
        var clickedElement = e.target;

        // make sure that the form was not clicked
        if (!clickedElement.closest(_utils.DOMElements.get("workoutClass"))) {
            return;
        }

        // if  the cross was clicked, search for the cross element
        // if it was not clicked it will be null
        var crossElement = clickedElement.closest(_utils.DOMElements.get("crossClass"));
        if (crossElement) {
        ...
        // lookup the id
        var id = clickedElement.closest(_utils.DOMElements.get("workoutClass")).getAttribute("data-id");

        // get the coordinates
        var coords = _MainModel.model.getCoordinatesOfWorkout(id);
        ...
        _MainView.view.changeMapFocus(coords);
    });
};
// delete the workout
var deleteWorkout = function deleteWorkout(id) {
    // delete the workout from the model
    _MainModel.model.deleteWorkout(id);
    // delete marker
    _MainView.view.deleteMarker(id);
    // delete workout from sidebar
    _MainView.view.deleteWorkout(id);
};

// load the static data
var loadAndRenderLocalStorageData = function loadAndRenderLocalStorageData() {
    // gets the workouts from the model
    var workouts = _MainModel.model.loadDataFromLocalStorage();
    // renders every workout
    workouts.forEach(function (workout) {
        _MainView.view.renderWorkout(workout);
        _MainView.view.setMarker(workout.coords, workout.type + ' on ' + (0, _utils.formatDate)(workout.date), workout.id);
    });
};
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return (0, _utils.getLocation)();

                    case 2:
                        coords = _context.sent;

                        // loads the map
                        map = _MainView.view.loadMap(coords);
                        ...
                        _utils.DOMElements.get("inputType").addEventListener("change", _MainView.view.switchElevGainAndCadence);
...
},{"core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./utils.js":"src/js/utils.js","./MainView.js":"src/js/MainView.js","./MainModel.js":"src/js/MainModel.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/controller.20d61af6.map